# Generated by Django 4.1.6 on 2023-06-06 22:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('diploma', '0020_delete_category_delete_confirm_remove_employer_user_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('topic', models.CharField(blank=True, help_text='Тема документа', max_length=280)),
                ('file', models.FileField(upload_to='document/', validators=[diploma.validator.validate_file_size])),
                ('time_create', models.DateTimeField(auto_now_add=True)),
                ('time_update', models.DateTimeField(auto_now=True)),
                ('category', models.CharField(blank=True, default='uncategorized', help_text='Категория', max_length=280)),
                ('date_confirm', models.CharField(blank=True, help_text='Дата утверждения', max_length=300, null=True)),
                ('confirm', models.CharField(blank=True, max_length=280)),
            ],
        ),
        migrations.CreateModel(
            name='employer',
